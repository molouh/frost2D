...
/** Definitions for common key codes. */
class KeyCode {
	...
	public static inline var PRINT_SCREEN:Int = 42;
	...
	public static inline var FORWAD_SLASH:Int = 191;
	public static inline var BACK_TICK:Int = 192;
	public static inline var BACK_SLASH:Int = 220;
